...
S_P=[]
C_P=[]'''
'''view=input("shopkeeper view or customer view")'''
while True:
    print("1.Shopkeeper \n2.Customer \n3.Close the shop")
    ...
    if view==1:
        while True:
            ...
            if Owner_id ==1562945 and Owner_password=="Lakshmi@2002":
                while True:
        ...
        Cust_No=int(input("Your Mobile Number Please!"))'''
                                ...
                                if len(Cust_No)==10:
                                    ...
                                    user_items_bought.append(cart)
                                            ...
                                            user_eachitems_bought_cost_total.append(total_cost_per_item)
                                             ...
                                             print("Mobile number must be 10 digits Please enter Correctly Sir")'''
